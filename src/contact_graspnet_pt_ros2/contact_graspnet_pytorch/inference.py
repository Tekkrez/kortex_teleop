...
def inference(global_config, 
    ...
    print("Time to Load estimator: " , time.time()-start)
    # Load the weights
    ...
    try:
        ...
        load_dict = {}
    print("Time to Load checkpoints: " , time.time()-start)
    ...
    for p in glob.glob(input_paths):
        ...
        print("Begin to Load data: " , time.time()-start)
        pc_segments = {}
        segmap, rgb, depth, cam_K, pc_full, pc_colors = load_available_input_data(p, K=K)
        print("End to Load data: " , time.time()-start)
        ...
        print("Done all Load data step: " , time.time()-start)
        ...
        print("End Inference: " , time.time()-start)
        # Save results
        ...
        print("Saved results: " , time.time()-start)

        # Visualize results          
        show_image(rgb, segmap)
        visualize_grasps(pc_full, pred_grasps_cam, scores, plot_opencv_cam=True, pc_colors=pc_colors)
        print("Done visualization: " , time.time()-start)
